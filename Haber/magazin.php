...
<div style="clear: both"></div>
    ...
    <main>
        ...
        <div id="baslik" style="width: 1100px;height:46px;border-bottom: 2px solid #f17599;">
            <h2 style="text-align: center;float: left;background-color:#f17599;color:white;font-weight:bold;font-size:40px;padding:2px 60px;width:auto;border-bottom-right-radius: 100px;border-top-left-radius:100px;">MAGAZİN</h2>
        ...
        <div id="slider_alani">
            ...
            <div id="slider">
                <ul class="slider">
                    <?php
                    $slider=mysql_query("select * from haberler WHERE haber_yer =1 and kategori_id=5 order by haber_id desc limit 10");
                ...
                <div class="sayfa">
                    <?php
                    $i=0;
                    $sayfa=mysql_query("select * from haberler WHERE haber_yer =1 and kategori_id=5 order by haber_id desc limit 10");
            ...
            <div id="yan_slider">
                <ul>
                    <ul class="yan_slider">
                        <?php
                        $yan_slider=mysql_query("select * from haberler where haber_yer=2 and kategori_id=5 order by haber_id desc limit 15");
        ...
        <div id="orta_alan">
            ...
            <div id="orta_alan_sol">
                <div id="usthaber_alan" style="max-width: 800px;height: auto; overflow: hidden;padding-left: 50px">
                    <h1 style="padding-left:180px;color: #f17599;font-size: 30px;font-weight: bold;font-family: tahoma, arial, sans-serif">MAGAZİN HABERLERİ</h1>
                    <ul style="max-width: 800px;height: auto; overflow: hidden">
                        <?php
                        $usthaber=mysql_query("SELECT * FROM  `haberler` WHERE haber_yer =1 AND kategori_id =5 order by haber_id desc LIMIT 10 ,21");
                        if(mysql_num_rows($usthaber)==0){
                        }else{
                            while($satır=mysql_fetch_array($usthaber)){
                                ?>
                ...
                <div id="en_cok_okunanlar">
                    ...
                    <ul>
                        <ul class="en_cok_okunanlar">
                            <?php
                            $en_cok_okunanlar = mysql_query("SELECT  * FROM  `haberler` where kategori_id=5 order by haber_id desc limit 30");
                ...
                <div id="dunden_kalanlar" style="">
                    ...
                    <ul>
                        <ul class="dunden_kalanlar">
                            <?php
                            $tarih = date("m.d.Y");
                            $dunden_kalanlar = mysql_query("SELECT  * FROM  `haberler` where ekleme_tarihi<'$tarih' and kategori_id=5 order by haber_id desc limit 30");
