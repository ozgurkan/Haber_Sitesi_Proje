                                        ...
                                        if(mysql_affected_rows()){
                                            ...
                                            if($Sifre==$SifreTk){
                                                ...
                                                if($insert){
                                                    ...
                                                    $mesaj="Sayın ".$Kullanici_Adi." Haber46 üyelik işleminizi başarıyla tamamladınız.Üyeliğini aktif etmek için lütfen aşağıdaki bağlantı adresine tıklayınız.".'</br><a href="http://ozgur.byethost10.com//UyeAktivasyon.php?aktivasyon_kodu='.$aktivasyon_kodu.'& uye_id='.$uye_id.'">Aktivasyon Linki</a>';
                                                    $mail = new PHPMailer();
                                                    $mail->IsSMTP();
                                                    $mail->SMTPAuth = true;
